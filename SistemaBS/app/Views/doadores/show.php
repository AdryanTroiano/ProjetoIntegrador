...
if (isset($erro)) {
    echo "<p class='doador-detalhes-erro'>" . htmlspecialchars($erro) . "</p>";
    exit;
}
...
<div class="doador-detalhes-container">
    ...
    <div class="doador-detalhes-tabela-container">
        ...
        <table class="doador-detalhes-tabela" id="printTable">
            ...
            <tr>
                <th>ID</th>
                <td><?= htmlspecialchars($doador['id']) ?></td>
            </tr>
            ...
            <tr>
                <th>Sexo</th>
                <td><?= htmlspecialchars($doador['sexo']) ?></td>
            </tr>
            ...
            <tr>
                <th>Número</th>
                <td><?= htmlspecialchars($doador['numero']) ?></td>
            </tr>

            <tr>
                <th>CEP</th>
                <td><?= htmlspecialchars($doador['cep']) ?></td>
            </tr>

            <tr>
                <th>Complemento</th>
                <td><?= htmlspecialchars($doador['complemento']) ?></td>
            </tr>

            <tr>
                <th>Bairro</th>
                <td><?= htmlspecialchars($doador['bairro']) ?></td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php
                    if (!empty($doador['nasc'])) {
                        echo (new DateTime($doador['nasc']))->format('d/m/Y');
                    }
                    ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td><?= htmlspecialchars($doador['tipo_sangue'] ?? '') ?></td>
            </tr>

            <tr>
                <th>Peso</th>
                <td><?= htmlspecialchars($doador['peso']) ?></td>
            </tr>
    ...
    <div class="doador-detalhes-voltar">
        ...
        <a href="?rota=doadores" class="doador-detalhes-btn">
            <i class="fas fa-arrow-left"></i> Voltar
        </a>

        <a
            href="?rota=editar&id=<?= (int)$doador['id'] ?>"
            class="doador-detalhes-btn"
        >
            <i class="fas fa-edit"></i> Editar
        </a>

        <a
            href="?rota=excluir&id=<?= (int)$doador['id'] ?>"
            class="doador-detalhes-btn btn-excluir"
            onclick="return confirm('Tem certeza que deseja excluir este doador?');"
        >
            <i class="fas fa-trash-alt"></i> Excluir
        </a>

        <button
            class="doador-detalhes-btn imprimir-btn"
            onclick="printTable()"
        >
        ...
        <button
            class="doador-detalhes-btn btn-exibir-cpf"
            onclick="toggleCpfVisibility(this)"
        >
...
function toggleCpfVisibility(buttonElement) {
    ...
    if (cpfField.type === "password") {
        ...
        buttonElement.innerHTML =
            '<i class="fas fa-eye-slash"></i> Esconder CPF';
